...
setwd('/Users/ellenrisemberg/Documents/ValdarFerris/Peanut_Crosses/backcross/candidate_genes')
...
for (i in 1:numQTL){
  ...
  vardata <- readr::read_csv(paste("results/vardata/", results[i], sep=""))
